<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\wamp\www\my_pro\wugu\public/../application/admin\view\customers\addCustomer.html";i:1513152825;s:75:"D:\wamp\www\my_pro\wugu\public/../application/admin\view\public\header.html";i:1512978529;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="crumb_warp">
        <i class="fa fa-home"></i> <a href="<?php echo url('index/info'); ?>">首页</a> &raquo; <a href="#">客户管理</a> &raquo; 新增客户
    </div>
    <!--结果集标题与导航组件 结束-->
    <div class="result_wrap">
        <form action="<?php echo url('addNewCustomer'); ?>" method="post" id="addCustomer">
            <table class="add_tab">
                <tbody>
                        <tr>
                            ...
                            <td>
                                <select name="customer_type">
                                    ...
                                    <option value="1">A客户</option>
                                    <option value="2">B客户</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="customer_source">
                                    <option value="">请选择</option>
                                    <option value="1">绵竹</option>
                                    <option value="2">彭州</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>性别：</th>
                            <td>
                                <label for=""><input type="radio" name="sex" value="1" checked>男</label>
                                <label for=""><input type="radio" name="sex" value="2">女</label>
                            </td>
                        </tr>
                        <tr>
                            <th>生日：</th>
                            <td>
                                <input type="text" class="" id="birthday" readonly>
                                <input type="hidden" class="birthday" name="birthday" id="bir">
                            </td>
                        </tr>
                        <tr>
                            <th>备注：</th>
...
<script>
    ...
    laydate.render({
        ...
        zIndex: 99999999,
            ...
            $("#bir").val((Date.parse(new Date(value)))/1000);
        }
    });
