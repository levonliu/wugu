<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\wamp\www\my_pro\wugu\public/../application/admin\view\customers\addSaleInfo.html";i:1513148149;s:75:"D:\wamp\www\my_pro\wugu\public/../application/admin\view\public\header.html";i:1512978529;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<link rel="stylesheet" href="__STATIC__/layui/layui.css">
...
<div class="result_wrap">
    <form action="<?php echo url('addSaleInfo'); ?>" method="post" id="addSaleInfo">
                    ...
                    $( form ).ajaxSubmit( {
                        success: function ( data ) {
                            if ( data.success ) {
                                ...
                                setTimeout( function () {
                                    window.location.href = "<?php echo url('showGoods'); ?>?customer_id=<?php echo $customer_id; ?>";
                                }, 1500 );
                            } else {
