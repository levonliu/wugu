<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"C:\wnmp\app\wugu\public/../application/admin\view\customers\showSaleInfo.html";i:1513347072;s:68:"C:\wnmp\app\wugu\public/../application/admin\view\public\header.html";i:1513347072;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="<?php echo url('addSaleInfo'); ?>?customer_id=<?php echo $customerInfo['id']; ?>" title="新增商品"><i
                        class="fa fa-fw fa-plus-circle"></i>新增</a>
            </div>
        </div>
        <!--快捷导航 结束-->
    </div>
        ...
        <div class="result_content">
            <table class="list_tab">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('editSaleInfo'); ?>?id=<?php echo $sList['id']; ?>" title="修改"><i class="fa fa-fw fa-edit"></i>修改</a>
                    </td>
                </tr>
