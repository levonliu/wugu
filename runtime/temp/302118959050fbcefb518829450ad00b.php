<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"C:\wnmp\app\wugu\public/../application/admin\view\customers\addSaleInfo.html";i:1513347072;s:68:"C:\wnmp\app\wugu\public/../application/admin\view\public\header.html";i:1513347072;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    $( form ).ajaxSubmit( {
                        success: function ( data ) {
                            if ( data.success ) {
                                ...
                                setTimeout( function () {
                                    window.location.href = "<?php echo url('showSaleInfo'); ?>?customer_id=<?php echo $customer_id; ?>";
                                }, 1500 );
                            } else {
