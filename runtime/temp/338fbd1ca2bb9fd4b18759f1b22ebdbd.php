<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\wamp\www\my_pro\wugu\public/../application/admin\view\customers\showGoods.html";i:1513072887;s:75:"D:\wamp\www\my_pro\wugu\public/../application/admin\view\public\header.html";i:1512978529;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <table class="list_tab">
                ...
                <?php if(is_array($saleInfo) || $saleInfo instanceof \think\Collection || $saleInfo instanceof \think\Paginator): $k = 0; $__LIST__ = $saleInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sList): $mod = ($k % 2 );++$k;?>
                    <tr>
                        ...
                        <td><?php echo $sList['update_time']; ?></td>
